...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN: "med-itrack-nduik.firebaseapp.com",
    NEXT_PUBLIC_FIREBASE_PROJECT_ID: "med-itrack-nduik",
    NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET: "med-itrack-nduik.firebasestorage.app",
